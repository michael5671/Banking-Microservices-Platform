package com.michael.accounts.controller;
...
@Tag(
        name ="CRUD REST APIs for Accounts in Bank Platform",
        description = "CRUD REST APIs in bank platform to Create, Update, Fetch and Delete account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside Bank Platform"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            summary = "Get contact info information REST API",
            description = "Get java version information that is installed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
